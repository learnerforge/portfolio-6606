...
const ICONS = {
  ...
  'rotate-cw': '<path d="M20.5 12a8.5 8.5 0 1 1-2.9-6.4L20.5 8"/><path d="M20.5 3v5h-5"/>',
  send: '<path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/>',
  sparkles: '<path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9z"/><path d="M19 17l.8 2.2L22 20l-2.2.8L23 23l-.8-2.2L20 20l2.2-.8z"/>',
